...
As we can see in the picture, the disassembler of **Kunai** is a *Linear Sweep Disassembly*, an idea for the future is implementing different algorithms of disassembly improving the efficiency of the algorithm.
